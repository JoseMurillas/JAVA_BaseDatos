...
public class Vendedor extends javax.swing.JFrame {
    ...
    private void ALTASActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ALTASActionPerformed
        ...
        ALTAS.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent arg0) {
                ...
                jLabel4.setText("");
                try {
                    try (Connection conexion = DriverManager.getConnection("jdbc:mysql://localhost:3306/id22198971_base2","id22198971_base","Jose12345#")) {
    ...
    private void Btn3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_Btn3ActionPerformed
        ...
        try {
            Connection
            conexion=DriverManager.getConnection("jdbc:mysql://localhost:3306/id22198971_base2","id22198971_base","Jose12345#");
            Statement comando=conexion.createStatement();
